    ...
    <div className='carouselBest'>
      ...
      <div style={{ width: 'auto', margin: 0, padding: 0 }}>
        <Carousel interval={5000}>
          <Carousel.Item>
            <img className='d-block w-100' src={sale1} alt='First slide' />
          </Carousel.Item>

          <Carousel.Item>
            <img className='d-block w-100' src={sale2} alt='Second slide' />
          </Carousel.Item>

          <Carousel.Item>
            <img className='d-block w-100' src={sale3} alt='Third slide' />
          </Carousel.Item>
        </Carousel>
      </div>
    </div>
